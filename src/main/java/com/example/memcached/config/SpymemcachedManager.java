...
/**
 *
 *java客户端 spymemcached方式
 * @Version: 1.0
 */
@Component
public class SpymemcachedManager implements CommandLineRunner {

    private Logger log = LoggerFactory.getLogger(SpymemcachedManager.class);
    /**
     * The Memcached ip.
     */
    @Value("${memcache.ip}")
    ...
    public void run(String... args) throws Exception {
        try {
            ...
            log.info("++++++++++++++++++++ Spymemcached方式 连接成功,Address:{}:{} ++++++++++++++++++++++", memcachedIp, memcachedPort);
        } catch (IOException e) {
            log.info("++++++++++++++++++++ Spymemcached方式 连接异常,Address:{}:{} ++++++++++++++++++++++{}", memcachedIp, memcachedPort, e);
        }
    }
